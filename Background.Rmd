...
Use visual analytics to identify which GASTech employees made which purchases and identify suspicious patterns of behavior. You must cope with uncertainties that result from missing, conflicting, and imperfect data to make recommendations for further investigation.
...
## Vast Challange 2021 Link

Please visit [Vast Challange 2021](https://vast-challenge.github.io/2021/MC2.html) for more information.